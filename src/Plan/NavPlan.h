...
public:
	...
	int Addgoal(const manager_msgs::Goal& goal, std::string& goalName);
	...
	std::map <int, manager_msgs::Goal> GetGoalList() { return m_GoalList; }
...
private:
	...
	std::map <int, manager_msgs::Goal> m_GoalList;
