...
void VideoLayer::ShowVideoControl()
{
	...
	ImGui::RadioButton(u8"打开 前摄像头", &radio_video1, 1);
	ImGui::SameLine(0, 10);
	ImGui::RadioButton(u8"关闭 前摄像头", &radio_video1, 0);
	ImGui::SameLine(0, 20);
	...
	ImGui::RadioButton(u8"打开 对接摄像头", &radio_video2, 1);
	ImGui::SameLine(0, 10);
	ImGui::RadioButton(u8"关闭 对接摄像头", &radio_video2, 0);
	ImGui::SameLine(0, 20);
	...
	ImGui::RadioButton(u8"打开 取油摄像头", &radio_video3, 1);
	ImGui::SameLine(0, 10);
	ImGui::RadioButton(u8"关闭 取油摄像头", &radio_video3, 0);
	ImGui::SameLine(0, 20);
